...
var AvailableCapabilities = []string{
	...
	"cosmwasm_1_4", "cosmwasm_2_0", "cosmwasm_2_1", "cosmwasm_2_2", "ibc2", "bulk_memory",
}
...
func TestInstantiate(t *testing.T) {
	...
	if types.EnableGasVerification {
		require.Equal(t, uint64(0x1b8b6), gasAfter-gasBefore)
	}
...
func TestExecute(t *testing.T) {
	...
	gasAfter := ctx.GasMeter().GasConsumed()
	if types.EnableGasVerification {
		require.Equal(t, uint64(0x1a22b), gasAfter-gasBefore)
	}
